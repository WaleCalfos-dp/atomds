...
const SECTIONS: BilingualNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/foundations/title', label: { en: 'Title', zh: '标题' } },
      { to: '/foundations/body', label: { en: 'Body', zh: '正文' } },
      { to: '/foundations/text-link', label: { en: 'Text Link', zh: '文本链接' } },
    ],
  },
  {
    id: 'tools',
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/components/country-code-dropdown', label: { en: 'Country Code Dropdown', zh: '国家代码下拉' } },
      { to: '/components/lightbox-image-viewer', label: { en: 'Lightbox Image Viewer', zh: '灯箱图片查看器' } },
      { to: '/components/loader', label: { en: 'Loader', zh: '加载中' } },
      { to: '/components/overlay', label: { en: 'Overlay', zh: '遮罩' } },
  ...
  {
    id: 'chrome',
    label: { en: 'Chrome', zh: '页面框架' },
    basePath: '/chrome',
    items: [
      { to: '/chrome/header', label: { en: 'Header', zh: '页头' } },
      { to: '/chrome/menu-bar', label: { en: 'Menu Bar', zh: '菜单栏' } },
      { to: '/chrome/bottom-navigation', label: { en: 'Bottom Navigation', zh: '底部导航' } },
      { to: '/chrome/desktop-footer', label: { en: 'Desktop Footer', zh: '页脚' } },
      { to: '/chrome/web-search', label: { en: 'Web Search', zh: '网页搜索' } },
    ],
  },
  {
    id: 'widgets',
    label: { en: 'Widgets', zh: '业务组件' },
    basePath: '/widgets',
    items: [
      { to: '/widgets/booking-widget', label: { en: 'Booking Widget', zh: '预订组件' } },
      { to: '/widgets/booking-details', label: { en: 'Booking Details', zh: '预订详情' } },
      { to: '/widgets/product-card', label: { en: 'Product Card', zh: '产品卡片' } },
      { to: '/widgets/product-images', label: { en: 'Product Images', zh: '产品图集' } },
      { to: '/widgets/product-preview', label: { en: 'Product Preview', zh: '产品预览' } },
      { to: '/widgets/payment-method', label: { en: 'Payment Method', zh: '支付方式' } },
      { to: '/widgets/payment-breakdown', label: { en: 'Payment Breakdown', zh: '支付明细' } },
      { to: '/widgets/payment-icons', label: { en: 'Payment Icons', zh: '支付图标' } },
    ],
  },
];
