...
export function ListItemPage({ brand }: ListItemPageProps) {
    ...
    <div className="space-y-10">
        ...
        <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm bg-white">
          <div className="flex flex-col md:flex-row min-h-72">
            ...
            <div className="w-full md:w-72 border-t md:border-t-0 md:border-l border-slate-200 bg-white p-5 flex flex-col gap-5">
              ...
              {/* Slot toggles */}
              <div>
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Slots</p>
                <div className="flex flex-col gap-2">
                  {[
                    { lbl: 'Leading icon',  val: showLeftIcon,  set: setShowLeftIcon,  disabled: type === 'Country' || type === 'Region' || type === 'Group' },
                    { lbl: 'Trailing icon', val: showRightIcon, set: setShowRightIcon, disabled: type === 'Country' || type === 'Region' || type === 'Group' },
                    { lbl: 'Checkbox',      val: showCheckbox,  set: setShowCheckbox,  disabled: type === 'Country' || type === 'Region' || type === 'Group' || type === 'Single + Description' },
      ...
      <section>
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">List Item</h1>
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-5">The List Item is composed of four parts. Leading and trailing slots are optional.</p>
      ...
      <section>
            ...
            <tbody>
              <tr className="border-b border-slate-100">
                ...
                <td className="px-5 py-3.5">
                  <div className="flex flex-wrap gap-1.5">
                    {ALL_TYPES.map((t) => (
                      <span key={t} className="inline-flex items-center px-2 py-0.5 rounded-md border border-slate-200 bg-slate-50 text-slate-600 text-xs font-medium">
                        {t}
                      </span>
                    ))}
                  </div>
              ...
              <tr className="border-b border-slate-100">
                <td className="px-5 py-3.5 font-medium text-slate-700 text-sm">Style</td>
                <td className="px-5 py-3.5">
        ...
        <div style={{ marginTop: '16px', display: 'grid', gridTemplateColumns: 'repeat(1, 1fr)', gap: '12px' }}>
          {ALL_TYPES.map((t) => (
            ...
            >
              <p style={{ margin: 0, fontSize: '12px', fontWeight: 600, color: '#6b7280' }}>{t}</p>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <ListItemLive
                  type={t}
                  itemStyle={t === 'Stacked' ? 'Not Interactive' : 'Interactive'}
                  state="Default"
                  showLeftIcon={t === 'Single' || t === 'Stacked' || t === 'Single + Description'}
                  showRightIcon={t === 'Single' || t === 'Stacked'}
                  brand={brand}
                />
              </div>
            </div>
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-4">
          Guidelines for implementing List Item in an inclusive way.
        </p>
      ...
      <section>
        ...
        <p style={{ fontSize: '13px', color: '#6b7280', margin: '0 0 16px' }}>
          When and how to use the List Item component.
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          <div style={{ padding: '14px 16px', borderRadius: '10px', border: '1px solid #bbf7d0', backgroundColor: '#f0fdf4' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', fontSize: '12.5px', color: '#15803d', lineHeight: 1.4 }}>
              <li style={{ marginBottom: '6px' }}>• Display a collection of items with consistent metadata</li>
              <li style={{ marginBottom: '6px' }}>• Build selectable picker lists (checkboxes, radio groups)</li>
              <li style={{ marginBottom: '6px' }}>• Navigate to a detail page for each row (Interactive)</li>
              <li>• Summarise grouped records with a shared section header</li>
            </ul>
          </div>
          <div style={{ padding: '14px 16px', borderRadius: '10px', border: '1px solid #fecaca', backgroundColor: '#fef2f2' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', fontSize: '12.5px', color: '#b91c1c', lineHeight: 1.4 }}>
              <li style={{ marginBottom: '6px' }}>• Don't use for a dense data grid — use a Table</li>
              <li style={{ marginBottom: '6px' }}>• Don't use for a single key-value pair — use a Data Row</li>
              <li style={{ marginBottom: '6px' }}>• Don't mix types inside one list (e.g. Country + Stacked)</li>
              <li>• Don't pack more than one Trailing slot — it crowds the row</li>
            </ul>
          </div>
        </div>
      </section>
