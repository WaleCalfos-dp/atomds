...
const TOKEN_TABLE_ROWS: { label: string; key: string; cssVar: string }[] = [
  { label: 'Link (default)', key: 'atom.foreground.core.fg-primary',        cssVar: '--atom-foreground-core-fg-primary' },
  { label: 'Current page',   key: 'atom.foreground.states.fg-pressed',      cssVar: '--atom-foreground-states-fg-pressed' },
  { label: 'Divider / dots', key: 'atom.foreground.core.fg-tertiary',       cssVar: '--atom-foreground-core-fg-tertiary' },
];
...
const ANATOMY_ITEMS: BreadcrumbItem[] = [
  { label: 'Home', href: '#' },
  { label: 'Components', href: '#' },
  { label: 'Breadcrumbs' },
];

export function BreadcrumbsPage({ brand }: BreadcrumbsPageProps) {
    ...
    <div className="space-y-10">
        ...
        <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm bg-white">
          <div className="flex flex-col md:flex-row min-h-72">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <BreadcrumbsLive
                    divider={divider}
                    count={count}
                    items={collapsed ? LONG_ITEMS : undefined}
            ...
            <div className="w-full md:w-72 border-t md:border-t-0 md:border-l border-slate-200 bg-white p-5 flex flex-col gap-5">
              ...
              <div>
                <p style={LABEL_STYLE}>Collapse</p>
                <div style={{ display: 'flex', padding: '2px', backgroundColor: '#f3f4f6', borderRadius: '8px', gap: '2px' }}>
                  <SegBtn active={!collapsed} onClick={() => setCollapsed(false)}>Off</SegBtn>
                  <SegBtn active={collapsed} onClick={() => setCollapsed(true)}>On</SegBtn>
                </div>
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">Breadcrumbs</h1>
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-5">The Breadcrumbs component is composed of four parts working together as a navigation landmark.</p>

        {/* Diagram area */}
        <div className="flex items-center justify-center py-20 px-8 rounded-xl" style={DOTTED_BG}>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <BreadcrumbsLive items={ANATOMY_ITEMS} divider="Chevron" brand={brand} />
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-slate-100">
                <td className="px-5 py-3.5 font-medium text-slate-700 text-sm">Divider</td>
              ...
              <tr className="border-b border-slate-100">
                <td className="px-5 py-3.5 font-medium text-slate-700 text-sm">Count</td>
                <td className="px-5 py-3.5">
              ...
              <tr className="border-b border-slate-100">
                <td className="px-5 py-3.5 font-medium text-slate-700 text-sm">Collapse</td>
                <td className="px-5 py-3.5 text-slate-600 text-sm">None · Ellipsis after N items (auto at Count = 6)</td>
              </tr>
              <tr>
                <td className="px-5 py-3.5 font-medium text-slate-700 text-sm">Item state</td>
                <td className="px-5 py-3.5 text-slate-600 text-sm">Link · Current page</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-4">
          Guidelines for implementing Breadcrumbs in an inclusive way.
        </p>
      ...
      <section>
        ...
        <p style={{ fontSize: '13px', color: '#6b7280', margin: '0 0 16px' }}>
          When and how to use the Breadcrumbs component.
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          <div style={{ padding: '14px 16px', borderRadius: '10px', border: '1px solid #bbf7d0', backgroundColor: '#f0fdf4' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', fontSize: '12.5px', color: '#15803d', lineHeight: 1.4 }}>
              <li style={{ marginBottom: '6px' }}>• Deep hierarchical navigation (3+ levels)</li>
              <li style={{ marginBottom: '6px' }}>• Users need to return quickly to ancestor pages</li>
              <li style={{ marginBottom: '6px' }}>• Location context matters (faceted search, doc sites)</li>
              <li>• Reinforce where the current page sits in the site tree</li>
            </ul>
          </div>
          <div style={{ padding: '14px 16px', borderRadius: '10px', border: '1px solid #fecaca', backgroundColor: '#fef2f2' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', fontSize: '12.5px', color: '#b91c1c', lineHeight: 1.4 }}>
              <li style={{ marginBottom: '6px' }}>• Only 1-level hierarchy — the trail adds noise</li>
              <li style={{ marginBottom: '6px' }}>• Linear flows (checkout, onboarding wizards)</li>
              <li style={{ marginBottom: '6px' }}>• A back-button pattern already covers the flow</li>
              <li>• Don't use as the only navigation — pair with a nav menu</li>
            </ul>
          </div>
        </div>
      </section>
