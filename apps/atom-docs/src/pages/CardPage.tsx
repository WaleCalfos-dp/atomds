...
import { CardLive, type CardImagePosition, type CardTextLine } from '@atom-core/components/card/CardLive';
import { type Brand, RESOLVED_SEMANTIC_TOKENS } from '@atom-core/tokens/tokens';
            ...
            <tbody>
              {[
                ...
                { label: t.propBooleans,  chips: [
                  {text: 'Title', note: ''}, {text: 'Badge 1', note: ''}, {text: 'Badge 2', note: ''}, {text: 'Badges', note: ''},
                  {text: 'Icon', note: ''}, {text: 'Icon 1', note: ''}, {text: 'Icon 2', note: ''},
                  {text: 'Flag', note: ''}, {text: 'Checkbox', note: ''}, {text: 'Button', note: ''},
                  {text: 'Amenities', note: ''}, {text: 'Amenity 1', note: ''}, {text: 'Amenity 2', note: ''}, {text: 'Amenity 3', note: ''}, {text: 'Amenity Plus badge', note: ''},
                  {text: 'Availablilty Details', note: 'sic — Figma typo'}, {text: 'Location', note: ''}, {text: 'Opening Time', note: ''},
                  {text: 'Lounge Type', note: ''}, {text: 'Bullet', note: ''}, {text: 'Bullet 1', note: ''}, {text: 'Bullet 2', note: ''},
                  {text: 'Show Text 1', note: ''}, {text: 'Show Text 2', note: ''}, {text: 'Show Text 3', note: ''}, {text: 'Show Text 4', note: ''},
                  {text: 'Line 1', note: ''}, {text: 'Line 2', note: ''},
                  {text: 'Description', note: ''}, {text: 'Description 2', note: ''},
                  {text: 'Image', note: ''}, {text: 'Pin', note: ''}, {text: 'Number', note: ''}, {text: 'Time and Duration', note: ''},
                ]},
                { label: t.propTextSlots, chips: [
                  ...
                  {text: 'Text 1', note: ''}, {text: 'Text 2', note: ''}, {text: 'Text 3', note: ''}, {text: 'Text 4', note: ''},
                  {text: 'Airline Name', note: ''}, {text: 'Flight Number', note: ''},
                  {text: 'Departure Date', note: ''}, {text: 'Departure Time', note: ''}, {text: 'Departure Airport', note: ''},
                  {text: 'Flight Type', note: ''}, {text: 'Arrival Date', note: ''}, {text: 'Arrival Time', note: ''}, {text: 'Arrival Airport', note: ''},
                  {text: 'Number Text', note: ''}, {text: 'Description Text', note: ''}, {text: 'Description 2 Text', note: ''},
                ]},
